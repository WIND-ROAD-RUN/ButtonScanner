...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / r"D:\y\yolov5-master\runs\train-seg\exp\weights\best.pt", help="model.pt path(s)")
    parser.add_argument("--imgsz", "--img", "--img-size", nargs="+", type=int, default=[640], help="image (h, w)")
