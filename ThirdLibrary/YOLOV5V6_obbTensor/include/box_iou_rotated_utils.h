...
single_box_iou_rotated(T cx0, T cy0, T width0, T height0, T theta0, T cx1, T cy1, T width1, T height1, T theta1) {
  // shift center to the middle point to achieve higher precision in result
  RotatedBox<T> box1, box2;
  auto center_shift_x = (cx0 + cx1) / 2.0;
  auto center_shift_y = (cy0 + cy1) / 2.0;
  box1.x_ctr = cx0 - center_shift_x;
  box1.y_ctr = cy0 - center_shift_y;
  box1.w = width0;
  box1.h = height0;
  box1.a = theta0;
  box2.x_ctr = cx1 - center_shift_x;
  box2.y_ctr = cy1 - center_shift_y;
  box2.w = width1;
  box2.h = height1;
  box2.a = theta1;
